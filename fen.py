        ...
        for x in row:
            ...
            if x.isalpha():
                match x:
                    ...
                    case 'r':
                        config.board[row_num][col_num].piece = piece.Piece("pawn", row_num, col_num, is_white, 'graphics/rook_black.png')
                    case 'R':
                        config.board[row_num][col_num].piece = piece.Piece("rook", row_num, col_num, is_white, 'graphics/rook_white.png')
                    case 'b':
                        config.board[row_num][col_num].piece = piece.Piece("pawn", row_num, col_num, is_white, 'graphics/bishop_black.png')
                    case 'B':
                        config.board[row_num][col_num].piece = piece.Piece("pawn", row_num, col_num, is_white, 'graphics/bishop_white.png')
                    case 'n':
                        config.board[row_num][col_num].piece = piece.Piece("pawn", row_num, col_num, is_white, 'graphics/pawn_black.png')
                    case 'N':
                        config.board[row_num][col_num].piece = piece.Piece("pawn", row_num, col_num, is_white, 'graphics/pawn_white.png')
